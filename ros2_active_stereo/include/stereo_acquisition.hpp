...
private:
    ...
    void acquire_cb(const std::shared_ptr<std_srvs::srv::SetBool::Request> request,
    ...
    rclcpp::Publisher<std_msgs::msg::Int8>::SharedPtr idx_proj_pub_;
    rclcpp::Subscription<std_msgs::msg::Int8>::SharedPtr n_imgs_sub_;
